"""
KaijiManga scraper (kaijimanga.com) - Kaiji (Nobuyuki Fukumoto) dedicated site.
...
class KaijiMangaScraper(BaseScraper):
    """Scraper for kaijimanga.com - Kaiji Ultimate Survivor manga."""
    ...
    def get_chapters(self, manga_url: str) -> List[Chapter]:
        ...
        for link in soup.select("a[href*='/manga/kaiji-chapter']"):
            href = link.get("href", "")
