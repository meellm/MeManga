"""
JJKaisen Scraper - Jujutsu Kaisen manga reader

URL: https://jjkaisen.com
Architecture: Nuxt SSR (same network as dddmanga.com, furieren.com, etc.)
Images: assets.jjkaisen.com CDN
"""
...
class JJKaisenScraper(BaseScraper):
    """Scraper for jjkaisen.com - Jujutsu Kaisen dedicated reader."""
    ...
    def search(self, query: str) -> List[Manga]:
        """Search for manga. This site is JJK-only."""
        if "jujutsu" in query.lower() or "jjk" in query.lower() or "kaisen" in query.lower():
            return [Manga(
                title="Jujutsu Kaisen",
                url=self.BASE_URL,
                cover_url=f"{self.BASE_URL}/volume-covers3/jjkaisen.webp",
                source="jjkaisen.com"
            )]
        return []
        ...
        try:
            ...
            if match:
                ...
                if chapter_matches:
                    ...
                    max_chapter = 271  # JJK ended at 271
    ...
    def get_pages(self, chapter_url: str) -> List[str]:
        ...
        try:
            ...
            img_matches = re.findall(
                rf'src="(https://assets\.jjkaisen\.com/jjkaisen/chapter-{chapter_num}/\d+\.(?:jpeg|jpg|png|webp))"',
                resp.text
            )
            ...
            if img_matches:
                ...
                all_imgs = re.findall(
                    r'src="(https://assets\.jjkaisen\.com/jjkaisen/[^"]+)"',
                    resp.text
                )
