"""
AoAshiManga scraper (ao-ashi-manga.com) - Ao Ashi dedicated site.

Uses WordPress with Comic Easel plugin, images hosted on laiond.com.
"""
...
class AoAshiMangaScraper(BaseScraper):
    """Scraper for ao-ashi-manga.com - Ao Ashi manga."""
