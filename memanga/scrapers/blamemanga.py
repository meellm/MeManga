"""
BlameManga scraper (blame-manga.com) - BLAME! dedicated site.

Uses WordPress with Comic Easel plugin, images hosted on Blogger CDN
(blogger.googleusercontent.com). Images are listed in og:image meta tags.

BLAME! is a sci-fi manga by Tsutomu Nihei, known for its atmospheric
art style and minimal dialogue.
"""
...
class BlameMangaScraper(BaseScraper):
    """Scraper for blame-manga.com - BLAME! manga."""
    ...
    def search(self, query: str) -> List[Manga]:
        ...
        return [Manga(
            title="BLAME!",
            url=f"{self.base_url}/",
            cover_url="https://w9.blame-manga.com/wp-content/uploads/2025/01/Blame-Manga-OpenGraph.webp",
        )]
    ...
    def get_chapters(self, manga_url: str) -> List[Chapter]:
        ...
        # Find chapter links
        for link in soup.select("a[href*='/manga/blame-chapter']"):
            href = link.get("href", "")
    ...
    def get_pages(self, chapter_url: str) -> List[str]:
        ...
        # Extract images from og:image meta tags (Blogger CDN)
