"""
FurierenManga scraper (furieren.com) - Frieren: Beyond Journey's End dedicated site.

Uses Nuxt.js with SSR, images hosted on assets.furieren.com.
...
class FurierenMangaScraper(BaseScraper):
    """Scraper for furieren.com - Frieren: Beyond Journey's End manga."""
    ...
    def search(self, query: str) -> List[Manga]:
        ...
        return [Manga(
            ...
            url=f"{self.base_url}/",
            cover_url="https://furieren.com/volume-covers3/frieren.webp",
        )]
    ...
    def get_pages(self, chapter_url: str) -> List[str]:
        ...
        if not pages:
            for meta in soup.select('meta[property="og:image"]'):
                ...
                if url and "assets.furieren.com" in url:
                    if url not in seen:
                        seen.add(url)
                        pages.append(url)
