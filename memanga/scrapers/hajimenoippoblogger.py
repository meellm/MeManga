"""
HajimeNoIppoBlogger scraper (hajime-noippo.com) - Hajime no Ippo dedicated site.

Uses WordPress, images hosted on Blogger CDN (bp.blogspot.com).
"""
...
class HajimeNoIppoBloggerScraper(BaseScraper):
    """Scraper for hajime-noippo.com - Hajime no Ippo manga (Blogger CDN)."""
    
    name = "hajimenoippoblogger"
    base_url = "https://w22.hajime-noippo.com"
    ...
    def get_chapters(self, manga_url: str) -> List[Chapter]:
        ...
        # Find chapter links (format: /manga/hajime-no-ippo-chapter-X/)
    ...
    def get_pages(self, chapter_url: str) -> List[str]:
        ...
        for img in entry.find_all("img"):
            ...
            # Accept images from Blogger CDN (bp.blogspot.com)
            if "bp.blogspot.com" in src and src not in seen:
                seen.add(src)
                pages.append(src)
