"""
AjimeNoIppo scraper (ajimenoippo.com) - Hajime no Ippo dedicated site.

Uses WordPress with lazy loading, images hosted on cdn.mangaclash.com.
"""
...
class AjimeNoIppoScraper(BaseScraper):
    """Scraper for ajimenoippo.com - Hajime no Ippo manga."""
    
    name = "ajimenoippo"
    base_url = "https://www.ajimenoippo.com"
