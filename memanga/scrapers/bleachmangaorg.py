"""
BleachMangaOrg scraper (bleachmanga.org) - Bleach dedicated site.

Uses WordPress Mangosm theme, images hosted on cdn.mangaclash.com.
"""
...
class BleachMangaOrgScraper(BaseScraper):
    """Scraper for bleachmanga.org - Bleach manga."""
    ...
    def get_chapters(self, manga_url: str) -> List[Chapter]:
        ...
        # Find chapter links in the chapter list
        for link in soup.find_all("a", href=re.compile(r'bleach-chapter', re.I)):
            href = link.get("href", "")
    ...
    def get_pages(self, chapter_url: str) -> List[str]:
        ...
        for img in entry.find_all("img"):
            ...
            # Accept images from cdn.mangaclash.com
            if "cdn.mangaclash.com" in src and src not in seen:
                seen.add(src)
                pages.append(src)
