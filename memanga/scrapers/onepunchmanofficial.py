"""
OnePunchManOfficial scraper (onepunchmanofficial.com) - One Punch Man dedicated site.

Uses Nuxt.js with SSR, images hosted on assets.onepunchmanofficial.com.
...
class OnePunchManOfficialScraper(BaseScraper):
    """Scraper for onepunchmanofficial.com - One Punch Man manga."""
    
    name = "onepunchmanofficial"
    ...
    def search(self, query: str) -> List[Manga]:
        ...
        return [Manga(
            title="One Punch Man",
            url=f"{self.base_url}/",
            cover_url="https://assets.onepunchmanofficial.com/onepunchmanofficial/cover.webp",
        )]
    ...
    def get_pages(self, chapter_url: str) -> List[str]:
        ...
        for img in soup.select("img"):
            ...
            if "assets.onepunchmanofficial.com" in url:
                if url not in seen:
                    seen.add(url)
                    pages.append(url)
