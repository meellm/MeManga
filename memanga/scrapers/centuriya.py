"""
Centuriya scraper (centuriya.com) - Centuria manga dedicated site.

Uses Nuxt.js with SSR, images hosted on assets.centuriya.com.
...
class CenturiyaScraper(BaseScraper):
    """Scraper for centuriya.com - Centuria manga."""
    ...
    def search(self, query: str) -> List[Manga]:
        ...
        return [Manga(
            title="Centuria",
            url=f"{self.base_url}/",
            cover_url="https://assets.centuriya.com/centuria/cover.webp",
        )]
    ...
    def get_pages(self, chapter_url: str) -> List[str]:
        ...
        for img in soup.select("img"):
            ...
            if "assets.centuriya.com" in url:
                if url not in seen:
                    seen.add(url)
                    pages.append(url)
