"""
LHTranslation scraper - WordPress Madara scanlation site with AJAX chapter loading.
Requires Playwright for JS rendering.

Site: https://lhtranslation.net
"""
...
class LHTranslationScraper(PlaywrightScraper):
    """Scraper for lhtranslation.net - WordPress Madara theme."""
