"""
MashleManga scraper (mashlemanga.net) - Mashle dedicated site.

Uses WordPress Madara theme, images proxied through img.spoilerhat.com to Wasabi S3.
"""
...
class MashleMangaScraper(BaseScraper):
    """Scraper for mashlemanga.net - Mashle manga."""
    ...
    def search(self, query: str) -> List[Manga]:
        ...
        return [Manga(
            ...
            url=f"{self.base_url}/",
            cover_url="https://mashlemanga.net/wp-content/uploads/2022/01/45.jpg",
        )]
    ...
    def get_chapters(self, manga_url: str) -> List[Chapter]:
        ...
        # Find chapter links (format: /manga/mashle-chapter-X/)
        for link in soup.select("a[href*='mashle-chapter-']"):
            href = link.get("href", "")
    ...
    def get_pages(self, chapter_url: str) -> List[str]:
        ...
        for img in reading_content.find_all("img", class_="wp-manga-chapter-img"):
            ...
            if "img.spoilerhat.com" in src or "wasabisys.com" in src:
                if src not in seen:
                    seen.add(src)
                    pages.append(src)
