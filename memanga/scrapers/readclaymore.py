"""
ReadClaymore Scraper - Claymore dedicated manga reader
Site: readclaymore.com
Content: Claymore by Norihiro Yagi (155 chapters)
...
class ReadClaymoreScraper(BaseScraper):
    """Scraper for readclaymore.com - Claymore dedicated site"""
    
    def __init__(self):
        super().__init__()
        self.base_url = "https://readclaymore.com"
        self.session = requests.Session()
        self.session.headers.update({
            'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/121.0.0.0 Safari/537.36',
            'Accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,*/*;q=0.8',
            'Accept-Language': 'en-US,en;q=0.9',
            'Referer': 'https://readclaymore.com/',
        })
    ...
    def search(self, query: str) -> List[Manga]:
        ...
        # This site only has Claymore
        if 'claymore' in query.lower() or not query:
            manga = Manga(
                title="Claymore",
                url=self.base_url,
    ...
    def get_chapters(self, manga_url: str) -> List[Chapter]:
        """Get list of chapters for Claymore"""
        chapters = []
        ...
        try:
            ...
            # Find all chapter links - pattern: /manga/claymore-chapter-X/
            chapter_links = soup.find_all('a', href=re.compile(r'/manga/claymore-chapter-\d+'))
