"""
AkiraManga scraper (akiramanga.com) - Akira dedicated site.
...
class AkiraMangaScraper(BaseScraper):
    """Scraper for akiramanga.com - Akira manga."""
    ...
    def get_chapters(self, manga_url: str) -> List[Chapter]:
        ...
        # Find chapter links in ceo_latest_comics_widget or Chapters_List
        for link in soup.select("a[href*='/manga/akira-chapter']"):
            href = link.get("href", "")
