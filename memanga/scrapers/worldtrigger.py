"""World Trigger scraper for world-trigger.online"""
...
class WorldTriggerOnlineScraper(BaseScraper):
    """Scraper for world-trigger.online - WordPress Toivo Lite theme + Blogger CDN (og:image)"""
    
    name = "WorldTriggerOnline"
    ...
    def search(self, query: str) -> List[Manga]:
        ...
        keywords = ["world trigger", "worldtrigger", "trigger", "border", "yuuma", "osamu"]
        
        if any(kw in query_lower for kw in keywords):
            return [Manga(
                title="World Trigger",
                url=self.base_url,
                cover="https://world-trigger.online/wp-content/uploads/2022/06/World-Trigger-Manga.webp",
                source=self.name
            )]
        return []
    ...
    def get_chapters(self, manga_url: str) -> List[Chapter]:
        ...
        try:
            ...
            # Find chapter links - format: /manga/world-trigger-chapter-N/
            for link in soup.find_all("a", href=True):
                href = link.get("href", "")
                if "/manga/world-trigger-chapter-" in href:
    ...
    def get_pages(self, chapter_url: str) -> List[str]:
        """Get all page images for a chapter via og:image meta tags"""
        pages = []
        ...
        try:
            ...
            # Method 1: Extract images from og:image meta tags (Blogger CDN pattern)
            ...
            # Method 2: Look for images in entry-content with Blogger CDN
            if not pages:
            ...
            # Method 3: Any image with Blogger CDN
            if not pages:
