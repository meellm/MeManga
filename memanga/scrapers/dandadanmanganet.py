"""
DandadanMangaNet scraper (dandadanmanga.net) - Dandadan dedicated site.
...
class DandadanMangaNetScraper(BaseScraper):
    """Scraper for dandadanmanga.net - Dandadan manga."""
    
    name = "dandadanmanganet"
    ...
    def search(self, query: str) -> List[Manga]:
        ...
        return [Manga(
            title="Dandadan",
            url=f"{self.base_url}/",
            cover_url="https://dandadanmanga.net/wp-content/uploads/2021/12/dandadan-manga-%e3%83%80%e3%83%b3%e3%83%80%e3%83%80%e3%83%b3.jpg",
        )]
    ...
    def get_chapters(self, manga_url: str) -> List[Chapter]:
        ...
        # Find chapter links (format: /manga/dandadan-chapter-X/)
        for link in soup.select("a[href*='dandadan-chapter-']"):
            href = link.get("href", "")
    ...
    def get_pages(self, chapter_url: str) -> List[str]:
        ...
        # Find images with wp-manga-chapter-img class or in reading content
