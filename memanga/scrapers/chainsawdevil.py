"""
ChainsawDevil Scraper - Chainsaw Man manga reader

URL: https://chainsawdevil.com
Architecture: Nuxt SSR (same network as dddmanga.com, furieren.com, etc.)
Images: assets.chainsawdevil.com CDN
"""
...
class ChainsawDevilScraper(BaseScraper):
    """Scraper for chainsawdevil.com - Chainsaw Man dedicated reader."""
    ...
    def search(self, query: str) -> List[Manga]:
        """Search for manga. This site is Chainsaw Man-only."""
        if "chainsaw" in query.lower() or "csm" in query.lower():
            return [Manga(
                title="Chainsaw Man",
                url=self.BASE_URL,
                cover_url=f"{self.BASE_URL}/volume-covers3/chainsaw-man.webp",
                source="chainsawdevil.com"
            )]
        return []
        ...
        try:
            ...
            if match:
                ...
                if chapter_matches:
                    ...
                    max_chapter = 200  # Chainsaw Man ongoing
    ...
    def get_pages(self, chapter_url: str) -> List[str]:
        ...
        try:
            ...
            img_matches = re.findall(
                rf'src="(https://assets\.chainsawdevil\.com/chainsaw-man/chapter-{chapter_num}/\d+\.(?:jpeg|jpg|png|webp))"',
                resp.text
            )
            ...
            if img_matches:
                ...
                # Fallback
                all_imgs = re.findall(
                    r'src="(https://assets\.chainsawdevil\.com/chainsaw-man/[^"]+)"',
                    resp.text
                )
                # Filter out thumbs
