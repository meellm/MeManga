"""
HeavenlyDelusion scraper (heavenly-delusion.com) - Tengoku Daimakyou dedicated site.
...
class HeavenlyDelusionScraper(BaseScraper):
    """Scraper for heavenly-delusion.com - Tengoku Daimakyou (Heavenly Delusion) manga."""
    
    name = "heavenlydelusion"
    ...
    def search(self, query: str) -> List[Manga]:
        ...
        return [Manga(
            title="Tengoku Daimakyou (Heavenly Delusion)",
            url=f"{self.base_url}/",
            cover_url=None,
        )]
    ...
    def get_chapters(self, manga_url: str) -> List[Chapter]:
        ...
        # Find chapter links (format: /manga/heavenly-delusion-chapter-X/)
        for link in soup.select("a[href*='heavenly-delusion-chapter-']"):
            href = link.get("href", "")
