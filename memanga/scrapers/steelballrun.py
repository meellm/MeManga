"""
Steel Ball Run scraper (steel-ball-run.com) - JoJo Part 7 dedicated site.
...
class SteelBallRunScraper(BaseScraper):
    """Scraper for steel-ball-run.com - JoJo's Bizarre Adventure Part 7: Steel Ball Run."""
    ...
    def search(self, query: str) -> List[Manga]:
        """Search for manga (primarily Steel Ball Run, also has JoJoLands)."""
        results = []
        
        # Main manga - Steel Ball Run
        if any(term in query.lower() for term in ["steel", "ball", "run", "jojo", "part 7", "sbr", "gyro", "johnny"]):
