"""
TokyoGhoulClub scraper (tokyoghoul.club) - Tokyo Ghoul dedicated site.
...
class TokyoGhoulClubScraper(BaseScraper):
    """Scraper for tokyoghoul.club - Tokyo Ghoul manga."""
    
    name = "tokyoghoulclub"
    base_url = "https://tokyoghoul.club"
    ...
    def search(self, query: str) -> List[Manga]:
        ...
        return [Manga(
            title="Tokyo Ghoul",
            url=f"{self.base_url}/",
            cover_url="https://tokyoghoul.club/wp-content/uploads/2025/07/tokyo-ghoul-cover-1.webp",
        )]
    ...
    def get_chapters(self, manga_url: str) -> List[Chapter]:
        ...
        # Find chapter links in table format
