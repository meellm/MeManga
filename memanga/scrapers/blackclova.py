"""
BlackClova scraper (blackclova.com) - Black Clover dedicated site.

Uses Nuxt.js with SSR, images hosted on assets.blackclova.com.
...
class BlackClovaScraper(BaseScraper):
    """Scraper for blackclova.com - Black Clover manga."""
    ...
    def search(self, query: str) -> List[Manga]:
        ...
        return [Manga(
            title="Black Clover",
            url=f"{self.base_url}/",
            cover_url="https://assets.blackclova.com/blackclover/cover.webp",
        )]
    ...
    def get_pages(self, chapter_url: str) -> List[str]:
        ...
        for img in soup.select("img"):
            ...
            if "assets.blackclova.com" in url:
                if url not in seen:
                    seen.add(url)
                    pages.append(url)
