"""
DeathNoteManga scraper (death-note-manga.com) - Death Note dedicated site.
...
class DeathNoteMangaScraper(BaseScraper):
    """Scraper for death-note-manga.com - Death Note manga."""
    
    name = "deathnotemanga"
    base_url = "https://w13.death-note-manga.com"
    ...
    def get_chapters(self, manga_url: str) -> List[Chapter]:
        ...
        # Find chapter links (format: /manga/death-note-chapter-X/)
        for link in soup.select("a[href*='death-note-chapter-']"):
            href = link.get("href", "")
            ...
            # Extract chapter number (format: death-note-chapter-110)
