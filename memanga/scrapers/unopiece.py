"""
UnoPiece scraper (unopiece.com) - One Piece dedicated site.

Uses Nuxt.js with SSR, images hosted on assets.unopiece.com.
...
class UnoPieceScraper(BaseScraper):
    """Scraper for unopiece.com - One Piece manga."""
    ...
    def search(self, query: str) -> List[Manga]:
        ...
        return [Manga(
            title="One Piece",
            url=f"{self.base_url}/",
            cover_url="https://assets.unopiece.com/onepiece/cover.webp",
        )]
